  ...
  volume_par *vpar, control_par *cpar, Calibration **calib, int match_counts[])
{
  ...
  printf("\n Entered correspondences\n");
  printf("counts: %d %d %d %d\n", match_counts[0],match_counts[1],match_counts[2],match_counts[3]);
